...
class TestPDFParser:
    def test_parse_account_transactions(self) -> None:
        ...
        try:
            ...
            assert stmt.lines[0].date is not None
            ...
            assert stmt.lines[0].id is not None
    ...
    def test_start_and_end_dates(self) -> None:
        ...
        try:
            ...
            assert stmt.start_date is not None
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("Cuenta movimientos del 1 enero 2025 al 31 enero 2025", "Account", None),
            ("Depot Umsätze vom 1. Januar 2025 bis 31. Januar 2025", "Deposit", None),
            ("Deposit transactions from Jan 1, 2025 to Jan 31, 2025", "Deposit", None),
        ],
    )
    ...
    def test_german_pdf_end_to_end(self) -> None:
        ...
        pdf.set_font("dejavu", size=12)
        pdf.text(10, y, "Konto Umsätze vom 1. Januar 2025 bis 31. Januar 2025")
        y += 8
